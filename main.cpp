...
void drawCube() {
    ...
    // pink panel
    glBegin(GL_TRIANGLE_STRIP);
    glColor4f(GOLD[1][0], GOLD[1][1], GOLD[1][2], 0.4);
    glVertex3f(.15,.05,-.1);
    glVertex3f(.15,.15,-.1);
    glVertex3f(.05,.05,-.1);
    glVertex3f(.05,.15,-.1);
    ...
    // blue panel
    glBegin(GL_TRIANGLE_STRIP);
    glColor4f(GOLD[2][0], GOLD[2][1], GOLD[2][2], 0.6);
    glVertex3f(.1,0,0);
    glVertex3f(.1,.1,0);
    glVertex3f(.15,.05,-.1);
    glVertex3f(.15,.15,-.1);
    ...
    // green panel
    glBegin(GL_TRIANGLE_STRIP);
    glColor4f(GOLD[0][0], GOLD[0][1], GOLD[0][2], 1);
    glVertex3f(.15,.15,-.1);
    glVertex3f(.05,.15,-.1);
    glVertex3f(.1, .1, 0);
    glVertex3f(0,.1,0);
    ...
    // white panel
    glBegin(GL_TRIANGLE_STRIP);
    glColor4f(GOLD[1][0], GOLD[1][1], GOLD[1][2], 0.8);
    glVertex3f(.15,.05,-.1);
    glVertex3f(.05,.05,-.1);
    glVertex3f(.1,0,0);
    glVertex3f(0,0,0);
    ...
    // yellow panel
    glBegin(GL_TRIANGLE_STRIP);
    glColor4f(GOLD[2][0], GOLD[2][1], GOLD[2][2], 1);
    glVertex3f(0,.1,0);
    glVertex3f(0,0,0);
    glVertex3f(.05,.15,-.1);
    glVertex3f(.05,.05,-.1);
